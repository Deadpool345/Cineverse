...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu"><p></p>
    	   <ul>
            <li><a href="Ges.php"class="selected">Ag.PROX ESTRE</a></li>
...
<form name"subirEstreno"  onsubmit="return formu(this)" method="POST" action="save_estreno.php" enctype="multipart/form-data">
<tr>
<td colspan="2"><center><h1>Agregar Prox.Estreno</h1></center></td>
</tr>
		<tr>
	<td > 
...
<tr>
<td colspan="5"><center><h1 style="color:orange">Proximos estrenos</h1></center></td>
