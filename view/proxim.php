...
<head>
    ...
    <link rel="preload" href="css/proxim.css" type="text/css">
    <link rel="stylesheet" href="css/proxim.css" type="text/css">
...
<h1 class="slide-content__title">ESTRENOS</h1>
<hr>
            <br>
</div>
<br>
...
<?php while($row=$resultado->fetch_assoc()){ ?>
    ...
    <a href="peliculas.php?id=<?php echo $row['id']; ?>">
        <img class="poster" src="<?php echo $row['foto'];?>" alt="<?php echo $row['nombre']; ?>">
        <span class="name"><?php echo $row['nombre']; ?></span>
      </a>
    </div>
