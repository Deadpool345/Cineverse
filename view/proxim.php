...
<head>
    ...
    <style>
        ...
        .movie-poster { width: 100%; height: 20rem; }
    </style>
            ...
            ?>
                <div class="text-center">
                    <a href="peliculas.php?id=<?php echo $row['id']; ?>">
                        <div class="movie-poster bg-gray-200 flex items-center justify-center overflow-hidden rounded-lg mb-4">
                            <img class="w-full h-[30rem] object-cover" src="<?php echo $row['foto']; ?>" alt="<?php echo $row['nombre']; ?>">
                        </div>
