  ...
  <div id="templatemo_body_wrapper">
    <div id="templatemo_wrapper">
      <div id="templatemo_header">
        <div id="site_title">
          <h1><img width="150" height="100" src="images/Logo1.webp" /></h1>
        </div>
      ...
      <div id="templatemo_middle">
        ...
        <table>
          ...
          <tr>
            ...
            <td width="800">
              ...
              <h1><label style="color:#222;"><?php echo $row['nombre']; ?></label>
                <p></p>
              </h1>
              ...
              <font size="5">
                ...
                <label style="background:#B404AE; color:white;"><?php echo $row['genero']; ?></label>
                <p></p>
              </font>
          ...
          <tr>
            ...
            <td colspan="3">
              <font size="4">
                <b>Sipnosis:</b>
                <p align="justify"><label align="justify"><?php echo $row['sipnosis']; ?></label></p>
              </font>
            </td>
        ...
        <tr>
          ...
          <td colspan="2" align="right">
            ...
            <a href="horario.php?id= <?php echo $row['id']; ?>titulo= <?php echo $row['nombre']; ?>"><button
                id="AP">COMPRAR BOLETO</button></a>
            <p></p>
          </td>
      ...
      <div id="templatemo_footer">
        <div class="col_2 left">Son las decisiones las que nos hacen ser quienes somos, y siempre podemos optar por
          hacer lo correcto.
